...
Import::php("OpenM-Book.gui.OpenM_Book_JSGeneratorServer");
Import::php("OpenM-Controller.gui.OpenM_ViewDefaultServer");
$server = new OpenM_Book_JSGeneratorServer($property->get(OpenM_ViewDefaultServer::ROOT) . "api/", OpenM_SERVICE_CONFIG_DIRECTORY . "/" . $property->get("Smarty.template_c.dir"), OpenM_SERVICE_CONFIG_DIRECTORY . "/" . $property->get("Smarty.cache.dir"));
$server->handle();
?>
