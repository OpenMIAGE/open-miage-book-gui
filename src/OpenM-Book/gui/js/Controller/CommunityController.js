...
OpenM_BookController.community.Actions.prototype.updateActions = function() {
    ...
    if (this.community.userCanAddSubCommunity || (this.community.moderatorCanAddSubCommunity && this.community.userIsModerator) || (this.community.adminCanAddSubCommunity && OpenM_BookDAO.user.DAO.me.isAdmin)) {
