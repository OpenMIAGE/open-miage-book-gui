...
OpenM_Book_CommunityPageController.prototype.display = function(enabled) {
...
OpenM_Book_CommunityChildsController.prototype.updateChilds = function() {
    var commintyChild;
...
OpenM_Book_CommunityUsersController.prototype.updateUsers = function() {
    var user;
    this.users = new Array();
...
OpenM_Book_CommunityUsersNotValidController.prototype.updateUsers = function() {
    var user;
    this.users = new Array();
    this.gui.users = new Array();
    var userController;
...
OpenM_Book_CommunityActionsController.prototype.updateActions = function() {
